...
![Epoch_Stats](~/Image/epoch_stats.png "Epoch Statistics at the end of training.")
...
![Test_Histogram](~/Image/histogram_posterior.png "Posterior Histogram for the Test dataset.")
![Loss Stats](~/Image/loss_stats.png "Loss Statistics for the Test dataset.")
